...
var patch = snabbdom_1.init([class_1.default, props_1.default, attributes_1.default, style_1.default, eventlisteners_1.default // attaches event listeners
...
const hTriangle = (id, degRotation) => snabbdom_pragma_1.default.createElement("polygon", {
  id: id,
...
const view = data => snabbdom_pragma_1.default.createElement("div", {
  className: "view"
}, snabbdom_pragma_1.default.createElement("h1", null, "Snabbdom SVG Carousel"), snabbdom_pragma_1.default.createElement("svg", {
  width: "380",
  height: "380",
  viewBox: "-190 -190 380 380"
}, snabbdom_pragma_1.default.createElement("g", {
  id: "carousel",
  style: {
    transform: gRotation()
  }
}, [hTriangle('yellow', 0), hTriangle('green', 60), hTriangle('magenta', 120), hTriangle('red', 180), hTriangle('cyan', 240), hTriangle('blue', 300)])), snabbdom_pragma_1.default.createElement("button", {
  "on-click": () => handleRotate(60)
}, "Rotate Clockwise"), snabbdom_pragma_1.default.createElement("button", {
  "on-click": () => handleRotate(-60)
}, "Rotate Anticlockwise"), snabbdom_pragma_1.default.createElement("button", {
...
module.exports = __webpack_require__(/*! /Users/dclain/Development/BOFSELF-DEV/vsc-svg/030_svg-dynamic/src/index.tsx */"./src/index.tsx");
