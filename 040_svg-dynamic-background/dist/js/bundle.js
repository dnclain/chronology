...
const snabbdom_jsx_1 = __webpack_require__(/*! snabbdom-jsx */ "./node_modules/snabbdom-jsx/snabbdom-jsx.js");

exports.AZoomIn = Symbol('AZoomIn');
exports.AZoomOut = Symbol('AZoomOut');
...
const update = (action, previous, payload) => {
  var model = Object.assign({}, previous);

  switch (action) {
    case exports.AZoomIn:
      model.zoom += payload.zoom;
      model.zoom = model.zoom > 10 ? 10 : model.zoom;
      break;

    case exports.AZoomOut:
      model.zoom -= payload.zoom;
...
const view = ({
  ...
  return snabbdom_jsx_1.html("div", null, snabbdom_jsx_1.html("p", null, model.zoom), snabbdom_jsx_1.html("div", null, snabbdom_jsx_1.html("button", {
    "on-click": () => {
      handler(exports.AZoomIn, {
        zoom: 0.1
      });
    }
  }, "+"), snabbdom_jsx_1.html("button", {
    "on-click": () => {
      handler(exports.AZoomOut, {
        zoom: 0.1
      });
    }
  }, "-")));
...
const props_1 = __importDefault(__webpack_require__(/*! snabbdom/modules/props */ "./node_modules/snabbdom/modules/props.js"));

const class_1 = __importDefault(__webpack_require__(/*! snabbdom/modules/class */ "./node_modules/snabbdom/modules/class.js"));

const attributes_1 = __importDefault(__webpack_require__(/*! snabbdom/modules/attributes */ "./node_modules/snabbdom/modules/attributes.js"));

const style_1 = __importDefault(__webpack_require__(/*! snabbdom/modules/style */ "./node_modules/snabbdom/modules/style.js"));

const eventlisteners_1 = __importDefault(__webpack_require__(/*! snabbdom/modules/eventlisteners */ "./node_modules/snabbdom/modules/eventlisteners.js"));

const chronology_1 = __webpack_require__(/*! ./components/chronology */ "./src/components/chronology.tsx");

const patch = snabbdom_1.init([class_1.default, props_1.default, attributes_1.default, style_1.default, eventlisteners_1.default // attaches event listeners
]);
var vnode; // Initial Model

var model;

const parentHandler = (action, newModel) => {
  model = chronology_1.Chronology.update(action, model, newModel);
  render();
};

model = chronology_1.Chronology.init(parentHandler);

const render = () => {
  const newVNode = snabbdom_jsx_1.html(chronology_1.Chronology.view, {
    model: model,
...
/***/ 0:
/*!*********************************************************************!*\
  !*** multi whatwg-fetch @babel/polyfill/noConflict ./src/index.tsx ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = __webpack_require__(/*! /Users/dclain/Development/BOFSELF-DEV/vsc-svg/040_svg-dynamic-background/src/index.tsx */"./src/index.tsx");
